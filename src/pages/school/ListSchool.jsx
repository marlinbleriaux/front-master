...
import SchoolTable from "../../partials/school/SchoolTable";
import statues from "../../common/enum/statues";
import { updateFilterData } from "../../utils/updateFilterData";

function ListSchool() {
  const dispatch = useDispatch();
  const { schools, pagination } = useSelector((state) => state.schools);
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
              ...
              <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                <div className="mr-5">
                  <SelectInput
                    option={[
                      { value: "name", name: "Nom" },
                      { value: "abr", name: "Abreviations" },
                      { value: "country", name: "Pays" },
                    ]}
                    onChange={(val) => {
                      setSearchBy(val);
                    }}
                ...
                >
                  ...
                  <span className="hidden xs:block ml-2">Créer une ecole</span>
                </a>
              </div>
            </div>
            ...
            <SchoolTable selectedItems={handleSelectedItems} />
