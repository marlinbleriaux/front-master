        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            >
                              <path
                                className={`fill-current text-slate-400 ${
                                  pathname.includes("users") && "!text-cyan-500"
                                }`}
                                d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z"
                              />
                              <path
                                className={`fill-current text-slate-600 ${
                                  pathname.includes("students") && "text-cyan-600"
                                }`}
                                d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"
                              />
                              <path
                                className={`fill-current text-slate-400 ${
                                  pathname.includes("students") && "text-cyan-200"
                                }`}
                                d="M12 15c-1.654 0-3-1.346-3-3 0-.462.113-.894.3-1.285L6 6l4.714 3.301A2.973 2.973 0 0112 9c1.654 0 3 1.346 3 3s-1.346 3-3 3z"
                              />
                            </svg>
              ...
              {/* Ecoles */}
              {/* <SidebarLinkGroup activecondition={pathname.includes("schools")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                          pathname.includes("schools") && "hover:text-slate-200"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            >
                              ...
                              <path
                                className={`fill-current text-slate-600 ${
                                  pathname.includes("schools") && "text-cyan-600"
                                }`}
                                d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"
                              />
                              <path
                                className={`fill-current text-slate-400 ${
                                  pathname.includes("schools") && "text-cyan-200"
                                }`}
                                d="M12 15c-1.654 0-3-1.346-3-3 0-.462.113-.894.3-1.285L6 6l4.714 3.301A2.973 2.973 0 0112 9c1.654 0 3 1.346 3 3s-1.346 3-3 3z"
                              />
                            </svg>
              ...
              {/* Infos */}
              {/* <SidebarLinkGroup activecondition={pathname.includes("infos")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                          pathname.includes("infos") && "hover:text-slate-200"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            >
                              <path
                                className={`fill-current text-slate-400 ${
                                  pathname.includes("infos") && "!text-cyan-500"
                                }`}
                                d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z"
                              />
                              <path
                                className={`fill-current text-slate-600 ${
                                  pathname.includes("infos") && "text-cyan-600"
                                }`}
                                d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"
                              />
                              <path
                                className={`fill-current text-slate-400 ${
                                  pathname.includes("infos") && "text-cyan-200"
                                }`}
                                d="M12 15c-1.654 0-3-1.346-3-3 0-.462.113-.894.3-1.285L6 6l4.714 3.301A2.973 2.973 0 0112 9c1.654 0 3 1.346 3 3s-1.346 3-3 3z"
                              />
                            </svg>
              ...
              {/* Papers */}
              {/* <SidebarLinkGroup activecondition={pathname.includes("papers")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                          pathname.includes("papers") && "hover:text-slate-200"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            >
                              ...
                              <path
                                className={`fill-current text-slate-600 ${
                                  pathname.includes("papers") && "text-cyan-600"
                                }`}
                                d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"
                              />
                              <path
                                className={`fill-current text-slate-400 ${
                                  pathname.includes("papers") && "text-cyan-200"
                                }`}
                                d="M12 15c-1.654 0-3-1.346-3-3 0-.462.113-.894.3-1.285L6 6l4.714 3.301A2.973 2.973 0 0112 9c1.654 0 3 1.346 3 3s-1.346 3-3 3z"
                              />
                            </svg>
              ...
              {/*logement*/}
              {/* <SidebarLinkGroup activecondition={pathname.includes("logement")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              {/*logement*/}
              {/* <SidebarLinkGroup activecondition={pathname.includes("chats")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                          pathname.includes("chats") && "hover:text-slate-200"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            >
                              <path
                                className={`fill-current text-slate-600 ${
                                  pathname.includes("chats") && "text-cyan-500"
                                }`}
                                d="M14.5 7c4.695 0 8.5 3.184 8.5 7.111 0 1.597-.638 3.067-1.7 4.253V23l-4.108-2.148a10 10 0 01-2.692.37c-4.695 0-8.5-3.184-8.5-7.11C6 10.183 9.805 7 14.5 7z"
                              />
                              <path
                                className={`fill-current text-slate-400 ${
                                  pathname.includes("chats") && "text-cyan-300"
                                }`}
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            >
                              <path
                                className={`fill-current text-slate-700 ${
                                  pathname.includes("job") && "!text-cyan-600"
                                }`}
                              ...
                              <path
                                className={`fill-current text-slate-600 ${
                                  pathname.includes("job") && "!text-cyan-500"
                                }`}
                              ...
                              <path
                                className={`fill-current text-slate-400 ${
                                  pathname.includes("job") && "!text-cyan-300"
                                }`}
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            >
                              <path
                                className={`fill-current text-slate-600 ${
                                  pathname.includes("tasks") && "text-cyan-500"
                                }`}
                              ...
                              <path
                                className={`fill-current text-slate-400 ${
                                  pathname.includes("tasks") && "text-cyan-300"
                                }`}
                ...
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current text-slate-600 ${
                          pathname.includes("campaigns") && "text-cyan-500"
                        }`}
                        d="M20 7a.75.75 0 01-.75-.75 1.5 1.5 0 00-1.5-1.5.75.75 0 110-1.5 1.5 1.5 0 001.5-1.5.75.75 0 111.5 0 1.5 1.5 0 001.5 1.5.75.75 0 110 1.5 1.5 1.5 0 00-1.5 1.5A.75.75 0 0120 7zM4 23a.75.75 0 01-.75-.75 1.5 1.5 0 00-1.5-1.5.75.75 0 110-1.5 1.5 1.5 0 001.5-1.5.75.75 0 111.5 0 1.5 1.5 0 001.5 1.5.75.75 0 110 1.5 1.5 1.5 0 00-1.5 1.5A.75.75 0 014 23z"
                      />
                      <path
                        className={`fill-current text-slate-400 ${
                          pathname.includes("campaigns") && "text-cyan-300"
                        }`}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="grow flex items-center">
                      <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                        <path
                          className={`fill-current text-slate-600 ${
                            pathname.includes("messages") && "text-cyan-500"
                          }`}
                          d="M14.5 7c4.695 0 8.5 3.184 8.5 7.111 0 1.597-.638 3.067-1.7 4.253V23l-4.108-2.148a10 10 0 01-2.692.37c-4.695 0-8.5-3.184-8.5-7.11C6 10.183 9.805 7 14.5 7z"
                        />
                        <path
                          className={`fill-current text-slate-400 ${
                            pathname.includes("messages") && "text-cyan-300"
                          }`}
                          d="M11 1C5.477 1 1 4.582 1 9c0 1.797.75 3.45 2 4.785V19l4.833-2.416C8.829 16.85 9.892 17 11 17c5.523 0 10-3.582 10-8s-4.477-8-10-8z"
                        />
                      </svg>
                    ...
                    <div className="flex flex-shrink-0 ml-2">
                      <span className="inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-cyan-500 px-2 rounded">
                        4
                      </span>
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current text-slate-600 ${
                          pathname.includes("inbox") && "text-cyan-500"
                        }`}
                        d="M16 13v4H8v-4H0l3-9h18l3 9h-8Z"
                      />
                      <path
                        className={`fill-current text-slate-400 ${
                          pathname.includes("inbox") && "text-cyan-300"
                        }`}
                ...
                >
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      <path
                        className={`fill-current text-slate-600 ${
                          pathname.includes("calendar") && "text-cyan-500"
                        }`}
                        d="M1 3h22v20H1z"
                      />
                      <path
                        className={`fill-current text-slate-400 ${
                          pathname.includes("calendar") && "text-cyan-300"
                        }`}
